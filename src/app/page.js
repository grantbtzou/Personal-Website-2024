      ...
      <div className="flex justify-center items-center grow">
        <div className="flex flex-col justify-start">
          ...
          <div className={`max-w-3xl mx-8 mt-28 sm:mt-4 mb-6 `}>
            ...
            <p className="text-md mt-1">I'm driven by a deep curiosity toward understanding how the world works and why, an attitude which I apply to every problem I face.</p>
